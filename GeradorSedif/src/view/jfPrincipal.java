...
public static void main(String[] args) throws Exception {
    ...
    /*
    	...
    	public static void selecionarEmpresa() throws Exception{
            ...
            if (apachepoi.consultar(m, a, i)){System.out.println("Empresa: "+ empresas[i][0] +", Competencia "+ m + " de "+ a + " Ja Gerado");
            } //316, 267
            else {
    		...
    		entrada.digitar("$");
    		if(m < 10) {entrada.digitar("0"+m+a);} else {
    		entrada.digitar(""+m+a);}//180 285
    		entrada.digitar("$ ");
